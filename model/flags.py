...
def get_flags():
    ...
    parser.add_argument("--seed", default=3401, type=int, help="Random seed")

    # optimizer
    parser.add_argument("--optimizer", default="adam", type=str, help="Optimizer")
    parser.add_argument("--lr_high", default=1e-3, type=float, help="Learning rate")
    parser.add_argument("--lr_low", default=9e-5, type=float, help="Learning rate (small)")
    parser.add_argument("--lr_gap", default=0.90, type=float, help="Learning rate gap")
    ...
    parser.add_argument("--max_epoch", default=20000, type=int, help="Number of max epochs for the last homotopy step")
